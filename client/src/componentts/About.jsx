    ...
    <section className='about'>
      <div className='content'>
        ...
        <div className='content-left'>
          ...
          <h3>Chess API is a REST API that accepts a board config JSON object and returns a legal moves JSON object.  Chess API can be used as an easy way to restrict a user from making illegal moves on a client side chess application.</h3>
          ...
          <h5>API Access</h5>
          <h6>193.46.198.215:8080/getLegalMoves</h6>
        </div>
